          ...
          <div class="card">
            ...
            <form method="get" action="">
              ...
              <div class="form-group col-md-3">
                ...
                <a href={{ url('admin/filiere/list') }} class="btn btn-success" style="margin-top: 30px;">Reset</a>
                  ...
                  <tbody>
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('admin/filiere/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                                <a href="{{ url('admin/filiere/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    @endforeach
